...
def emit_turn(langfuse: Langfuse, session_id: str, turn_num: int, turn: Turn, transcript_path: Path, user_id=None) -> None:
...
def main() -> int:
    ...
    user_id = os.environ.get("CC_LANGFUSE_USER_ID") or os.environ.get("CODER_WORKSPACE_OWNER_NAME") or os.environ.get("USER")
